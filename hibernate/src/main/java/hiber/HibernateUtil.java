...
public class HibernateUtil {
    ...
    static {
        ...
        dbSettings.put(Environment.URL, "jdbc:mysql://remotemysql.com:3306/eYcooOkOuh");
        dbSettings.put(Environment.USER, "eYcooOkOuh");
        dbSettings.put(Environment.PASS, "OPDoegkjHh");
